                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form action="/centros-tech/editar/<?= $centroTech['id'] ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre" value="<?= $centroTech['nombre'] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Descripcion</label>
                            <textarea name="descripcion" id="descripcion" rows="5" class="form-control"><?= $centroTech['descripcion'] ?></textarea>
                        </div>
